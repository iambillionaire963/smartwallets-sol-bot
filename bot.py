...
async def show_signals_preview(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "⏰ Age: 3m  📊 Curve: 77.8%\n"
        "🔥 LP Burn: 100%\n"
        "🔢 Score: 10/10  🏆 Top: 10 21-32%\n"
        "💎 SmartW: 30 (21.14%)\n\n"
        "💰 Smart-Money InFlow:\n"
        "👛 30 tracked wallets bought (last 1m)\n"
        "💵 Total Inflow: 35.72 SOL\n\n"
        "🌐 Socials: Website · X\n"
        ...
        "Trojan Bot  •  Bloom\n"
        "GMGN Bot  •  GMGN Web\n"
        "SolanaHacker  •  Top Wallets\n"
        "Padre  •  Dexscreener\n"
        "```\n\n"
        
        "⚡ *What You Get:*\n"
        "• 30-50 signals like these DAILY\n"
        "• Full token metrics + smart money data\n"
        "• Instant buy buttons to all major bots\n"
        "• Real-time milestone tracking (3x, 6x, 9x+)\n"
        "• Smart wallet inflow analysis\n\n"
